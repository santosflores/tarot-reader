            ...
            <main className="max-w-5xl mx-auto px-6 pb-20">
                ...
                <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-purple-500/20">
                    ...
                    <p className="text-slate-300 mb-6 max-w-md mx-auto">
                        Understanding {card.name} is just the beginning. Speak with our Tarot Reader for a deeply personal reading with <strong>immersive voice guidance</strong>. Hear the cards reveal your path.
                    </p>
                    <Link
                        to="/"
