...
export const UI = () => {
  ...
  return (
    <div className="absolute top-2.5 left-[11px] z-[100] bg-white p-[15px] rounded-lg shadow-lg w-[300px] max-h-[calc(100vh-20px)] overflow-y-auto flex flex-col">
      {/* User Section */}
      {!loading && user && (
        <div className="mb-0 p-0 flex flex-col" style={{ boxSizing: 'content-box', borderBottom: 'none', borderImage: 'none' }}>
          <Link
            to="/profile"
            className="flex items-center gap-2 flex-1 min-w-0 hover:opacity-80 transition-opacity mb-2"
          >
