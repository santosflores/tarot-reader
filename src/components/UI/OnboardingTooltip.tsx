        ...
        <div className="relative w-[80vw] mx-auto bg-gradient-to-br from-purple-900/95 to-indigo-900/95 backdrop-blur-md rounded-2xl border border-purple-400/30 shadow-2xl shadow-purple-900/50 overflow-hidden">
          ...
          <div className="px-5 pb-4 space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="pt-0.5">
                <p className="text-purple-100 text-sm font-medium">Open the Channel</p>
                <p className="text-purple-300/70 text-xs mt-0.5">The purple orb below</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="pt-0.5">
                <p className="text-purple-100 text-sm font-medium">Grant Permission</p>
                <p className="text-purple-300/70 text-xs mt-0.5">So the Oracle can hear you</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="pt-0.5">
                <p className="text-purple-100 text-sm font-medium">Observe the Aura</p>
                <p className="text-purple-300/70 text-xs mt-0.5">It shows the connection state</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="pt-0.5">
                <p className="text-purple-100 text-sm font-medium">Speak Your Truth</p>
                <p className="text-purple-300/70 text-xs mt-0.5">The Oracle is listening</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2.5">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-purple-300/70 text-xs mt-0.5">Attuning frequencies...</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-purple-300/70 text-xs mt-0.5">Oracle is speaking...</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-purple-300/70 text-xs mt-0.5">Connection clouded</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="px-5 pb-4 border-t border-purple-400/20 pt-4">
            ...
            <p className="text-purple-300/70 text-xs">
              When the orb turns <span className="text-red-300 font-medium">red with an X icon</span>, click it to sever the connection.
            </p>
          </div>
